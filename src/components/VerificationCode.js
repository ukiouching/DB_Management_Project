...
import VertificationCodeNav from "./VertificationCodeNav";
export default function VertificationCode({ params }) {
  return (
    <>
      <div className="w-full h-full flex flex-col items-center border-l border-l-gray-400 relative">
        <VertificationCodeNav />
        <div className="basis-[93.5%] w-2/3 flex justify-center items-center">
          <div className="border border-gray-400 bg-slate-400 rounded-3xl flex flex-col justify-evenly items-center w-2/3 h-2/3">
            <div className="flex space-x-1">
              ...
              <div className="text-2xl font-bold">創群成功</div>
            </div>

            <div className="w-1/3 h-1/6 flex bg-slate-300 rounded-lg items-center justify-center self-center">
              <div className="text-xl font-semibold">123456</div>
            </div>
            <div className="flex  rounded-lg items-center justify-center">
              <div className="text-xl font-semibold">這是你的群組驗證碼！</div>
            </div>
