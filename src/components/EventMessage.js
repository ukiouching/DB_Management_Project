...
export default function EventMessage({ params }) {
  return (
    <>
          ...
          <div className="flex flex-col basis-2/5 bg-slate-300">
            <div className="w-full text-lg font-bold ">
              ...
              <div className="overflow-hidden whitespace-nowrap text-ellipsis pl-2 ">
                揪團113-1資料庫管理活動名稱這是一段超長文字我要測試換行
              </div>
            </div>
            <div className="w-full text-center text-sm font-semibold pt-5 ">
              <Link href="/outcome" className="w-full h-full text-slate-700 ">
                查看結果
              </Link>
            </div>
          </div>
          <div className="  border-t border-slate-400">
            <Link href="/vote" className="w-full flex justify-between">
